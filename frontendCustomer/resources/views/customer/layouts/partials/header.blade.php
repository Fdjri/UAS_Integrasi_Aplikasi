    ...
    <div style="position: relative; display: inline-block;">
      ...
      <div id="profileDropdown" 
        ...
        <ul style="list-style:none; padding:0; margin:0;">
          {{-- menu items --}}
          <li><a href="{{ route('customer.profile.frontend') }}" style="display:block; padding:0.75rem 1rem; color:#333; text-decoration:none; border-bottom:1px solid #eee;">Profile</a></li>
          <li><a href="{{ route('customer.bookings.index') }}" style="display:block; padding:0.75rem 1rem; color:#333; text-decoration:none; border-bottom:1px solid #eee;">Pesanan Kamu</a></li>
          <li><a href="{{ route('customer.bookings.history') }}" style="display:block; padding:0.75rem 1rem; color:#333; text-decoration:none; border-bottom:1px solid #eee;">Riwayat</a></li>
          <li>
